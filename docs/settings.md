...
[ArduPilot](https://ardupilot.org/) Copter & Rover vehicles are supported in latest HERCULES main branch & releases `v1.3.0` and later. For settings and how to use, please see [ArduPilot SITL with HERCULES](https://ardupilot.org/dev/docs/sitl-with-airsim.html)
