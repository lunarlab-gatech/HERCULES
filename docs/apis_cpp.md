...
// ready to run example: https://github.com/Cosys-Lab/HERCULES/blob/main/HelloCar/main.cpp
...
// ready to run example: https://github.com/Cosys-Lab/HERCULES/blob/main/HelloDrone/main.cpp
