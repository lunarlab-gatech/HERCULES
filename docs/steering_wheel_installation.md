...
To use Logitech G920 steering wheel with HERCULES follow these steps:
...
3. Before debug, you’ll have to normalize the values in HERCULES code. Perform this changes in CarPawn.cpp (according to the current update in the git):  
...
4. Debug HERCULES project (while the steering wheel is connected – it’s important).
