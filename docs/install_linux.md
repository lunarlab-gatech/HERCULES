# Intall or Build HERCULES on Linux
...
- Clone HERCULES and build it:
   ...
   git clone https://github.com/Cosys-Lab/HERCULES.git
   cd HERCULES
   ./setup.sh
   ./build.sh
   ```
...
- Alternatively, the project file can be passed as a commandline argument. For Blocks: `./Engine/Binaries/Linux/UnrealEditor <HERCULES_path>/Unreal/Environments/Blocks/Blocks.uproject`
- If you get prompts to convert project, look for More Options or Convert-In-Place option. If you get prompted to build, choose Yes. If you get prompted to disable HERCULES plugin, choose No.
