...
AirSim has code to write pfm file for [C++](https://github.com/Cosys-Lab/HERCULES/blob/main/AirLib/include/common/common_utils/Utils.hpp#L637) and read as well as write for [Python](https://github.com/Cosys-Lab/HERCULES/tree/main/PythonClient/airsim/utils.py#L122).
