...
```
## Usage example
Python script [detection.py](https://github.com/Cosys-Lab/HERCULES/blob/main/PythonClient/detection/detection.py) shows how to set detection parameters and shows the result in OpenCV capture.
