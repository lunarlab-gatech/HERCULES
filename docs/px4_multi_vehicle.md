...
If you want to start your SITL instances while being able to view the PX4 console, you will need to run the shell scripts found [here](https://github.com/Cosys-Lab/HERCULES/blob/main/PX4Scripts) rather than `sitl_multiple_run.sh`.
...
1. From your bash (or Cygwin) terminal go to the PX4 directory and get the scripts (place them in a subdirectory called Scripts win the PX4 directory as shown)
    ...
    mkdir -p Scripts
    cd Scripts
    wget https://github.com/Cosys-Lab/HERCULES/raw/main/PX4Scripts/sitl_kill.sh
    wget https://github.com/Cosys-Lab/HERCULES/raw/main/PX4Scripts/run_airsim_sitl.sh
    ```
