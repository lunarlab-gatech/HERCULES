...
HERCULES is a simulator for drones, cars and more, with extensive API support, built on [Unreal Engine](https://www.unrealengine.com/). It is open-source, cross platform, and supports hardware-in-loop with popular flight controllers such as PX4 for physically and visually realistic simulations. It is developed as an Unreal plugin that can simply be dropped into any Unreal environment. 
...
The [original AirSim MIT license](https://github.com/Cosys-Lab/HERCULES/blob/main/LICENSE) applies to all native AirSim source files. 
Please note that we use that same [MIT license](https://github.com/Cosys-Lab/HERCULES/blob/main/LICENSE) as which applies to all changes made by Cosys-Lab in case you plan to do anything within this repository.
...
This branch is for Unreal [5.2.1](https://github.com/Cosys-Lab/HERCULES/tree/5.2.1), maintained for support, and is available for long term support builds in the [releases](https://github.com/Cosys-Lab/HERCULES/releases). The documentation is best read from [source](https://github.com/Cosys-Lab/HERCULES/tree/main/docs). 
For more recent Unreal Engine versions check the other [releases](https://github.com/Cosys-Lab/HERCULES/releases) and the [main branch](https://github.com/Cosys-Lab/HERCULES) for the latest source code. 
...
You can also find the presentation of the live tutorial of HERCULES at ANNSIM '23 conference [here](https://github.com/Cosys-Lab/HERCULES/tree/main/docs/annsim23_tutorial) together with the associated videos.
...
* Updated C++ [ROS2 implementation](https://cosys-lab.github.io/ros_cplusplus) to support custom HERCULES features.
* Dropped support for Unity Environments.

Some more details on our changes can be found in the [changelog](https://github.com/Cosys-Lab/HERCULES/blob/main/CHANGELOG.md).
...
This project is released under the MIT License. Please review the [License file](https://github.com/Cosys-Lab/HERCULES/blob/main/LICENSE) for more details.
